...
fun DetallePruebaScreen(navController: NavController) {
    Column(
        ...
        Text("Evalúa la resistencia muscular del abdomen. Consiste en realizar el mayor número de abdominales posibles en 30 segundos, manteniendo la técnica adecuada.",
            color = colorScheme.onBackground)
