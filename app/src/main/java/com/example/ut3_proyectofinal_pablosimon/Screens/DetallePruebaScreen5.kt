...
fun DetallePruebaScreen5(navController: NavController) {
    Column(
        ...
        Text("Evalúa la fuerza explosiva de los brazos y el tronco. Se lanza un balón medicinal de 2 kg desde una posición estática, buscando alcanzar la mayor distancia posible.",
            color = colorScheme.onBackground)
